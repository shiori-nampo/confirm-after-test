...
<div class="confirm-form">
  <h2 class="confirm__header content__heading">Confirm</h2>
  <div class="confirm-form__inner">
    <form action="/thanks" method="post">
      ...
      <div class="confirm-form__btn-inner">
        <button class="confirm-form__send-btn btn" type="submit" name="send">送信</button>
        <button class="confirm-form__back-btn" type="submit" name="back">修正</button>
      </div>
    </form>
  </div>
</div>
